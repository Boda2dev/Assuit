...
class sec_computer extends StatefulWidget {
  const sec_computer({super.key});

  @override
  State<sec_computer> createState() => _sec_computerState();
}

// ignore: camel_case_types
class _sec_computerState extends State<sec_computer> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/computer/sec/Chapter 2.pdf',
                    'Chapter 2.pdf'),
