...
class sec_datastrc extends StatefulWidget {
  const sec_datastrc({super.key});

  @override
  State<sec_datastrc> createState() => _sec_datastrcState();
}

// ignore: camel_case_types
class _sec_datastrcState extends State<sec_datastrc> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/datastrc/sec/Python(1,2).pdf',
                    'Python(1,2).pdf'),
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/datastrc/sec/Python(1).pdf',
                    'Python(1).pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/datastrc/sec/Sheet 1.pdf', 'Sheet 1.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "Sheet 1",
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/datastrc/sec/Sheet 2 Solution.pdf',
                    'Sheet 2 Solution.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "Sheet 2 Solution",
