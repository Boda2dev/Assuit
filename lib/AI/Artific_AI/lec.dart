        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/ai/lec/AI_Chapter_01.pdf',
                    'AI_Chapter_01.pdf'),
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/ai/lec/AI_Chapter_02.pdf',
                    'AI_Chapter_02.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/ai/lec/AI_Chapter_03_part_1.pdf',
                    'AI_Chapter_03_part_1.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "AI_Chapter_03_part_1",
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 250, 252, 253),
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/ai/lec/AI_Chapter_03_part_2.pdf',
                    'AI_Chapter_03_part_2.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "AI_Chapter_03_part_2",
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 250, 252, 253),
