...
class sec_data extends StatefulWidget {
  const sec_data({super.key});

  @override
  State<sec_data> createState() => _sec_dataState();
}

// ignore: camel_case_types
class _sec_dataState extends State<sec_data> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/database/sec/DB - Sheet 1.pdf',
                    'DB - Sheet 1.pdf'),
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/database/sec/DB - Sheet 2.pdf',
                    'DB - Sheet 2.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/database/sec/DB - Sheet 3.pdf',
                    'DB - Sheet 3.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/database/sec/DB - Sheet4.pdf',
                    'DB - Sheet4.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
