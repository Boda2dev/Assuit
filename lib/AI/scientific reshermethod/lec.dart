...
class since extends StatefulWidget {
  ...
  @override
  State<since> createState() => _sinceState();
}

// ignore: camel_case_types
class _sinceState extends State<since> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/AI/since/Lec1 - What is Research.pdf',
                    'Lec1 - What is Research.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "Lec1 - What is Research",
                  style: TextStyle(
                    fontSize: 18,
