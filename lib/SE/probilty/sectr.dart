...
class pro_section extends StatefulWidget {
  const pro_section({super.key});

  @override
  State<pro_section> createState() => _pro_sectionState();
}

// ignore: camel_case_types
class _pro_sectionState extends State<pro_section> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/problatiy/sec/Section 1 ( السبورات ).pdf',
                    'Section 1 ( السبورات ).pdf'),
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/problatiy/sec/Section 1 (ورق دكتور صفاء).pdf',
                    'Section 1 (ورق دكتور صفاء).pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "Section 1 (ورق دكتور صفاء).pdf",
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/problatiy/sec/Section 1&2&3 (ورق دكتور صفاء).pdf',
                    'Section 1&2&3 (ورق دكتور صفاء).pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "Section 1&2&3 (ورق دكتور صفاء)",
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 250, 252, 253),
