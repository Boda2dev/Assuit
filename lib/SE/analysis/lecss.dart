...
class Lec_An extends StatefulWidget {
  const Lec_An({super.key});

  @override
  State<Lec_An> createState() => _Lec_AnState();
}

// ignore: camel_case_types
class _Lec_AnState extends State<Lec_An> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/analysis/Lecture 1.pdf', 'Lecture 1.pdf'),
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/analysis/Lecture 3.pdf', 'Lecture 3.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "lec 3",
