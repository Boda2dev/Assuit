...
class database_lec extends StatefulWidget {
  const database_lec({super.key});

  @override
  State<database_lec> createState() => _database_lecState();
}

// ignore: camel_case_types
class _database_lecState extends State<database_lec> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/Data_base/Lecture 1.pdf', 'Lecture1.pdf'),
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/Data_base/Lec02 - ERD.pdf',
                    'Lec02 - ERD.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/Data_base/Lec02 -  Data Models.pdf',
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/Data_base/Lecture 3.pdf', 'Lecture 3.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "Lecture 3",
