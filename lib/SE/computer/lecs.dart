...
class Lec_cs extends StatefulWidget {
  const Lec_cs({super.key});

  @override
  State<Lec_cs> createState() => _Lec_csState();
}

// ignore: camel_case_types
class _Lec_csState extends State<Lec_cs> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/computer/Computer_section.pdf',
                    'Computer_section.pdf'),
