...
class Computer_section extends StatefulWidget {
  const Computer_section({super.key});

  @override
  State<Computer_section> createState() => _Computer_sectionState();
}

// ignore: camel_case_types
class _Computer_sectionState extends State<Computer_section> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/computer/Chapter 2 part 2.pdf',
