...
class DataStructurePDF extends StatefulWidget {
  const DataStructurePDF({super.key});

  @override
  State<DataStructurePDF> createState() => _DataStructurePDFState();
}

class _DataStructurePDFState extends State<DataStructurePDF> {
        ...
        Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/Data_stc/Lecture 1.pdf', 'Lecture1.pdf'),
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/Data_stc/Lecture 2.pdf', 'Lecture2.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "lec2",
              ...
              ElevatedButton.icon(
                onPressed: () => _openPDF(
                    'assets/pdf/SE/Data_stc/Lecture 3.pdf', 'Lecture2.pdf'),
                icon: Icon(Icons.picture_as_pdf,
                    color: Color.fromARGB(255, 250, 2, 2)),
                label: Text(
                  "lec3",
